import qs from './quoteFeedSimulator.js'
...
quoteFeedSimulator.formatChartData = function (response, symbol) {
  ...
  const formatResponse = ({ dt, yieldCurve, priceCurve, curveUpdates }) => {
    ...
    if (!this.cachedData[symbol] || dt >= this.cachedData[symbol].dt) { this.cachedData[symbol] = { dt, yieldCurve, priceCurve, curveUpdates } }
    let response = {}
