...
CIQ.Drawing.prototype.setLineColor = function () {
  ...
  if (CIQ.Drawing.prototype.getLineColor) { return CIQ.Drawing.prototype.getLineColor.apply(this, arguments) }
}
...
CIQ.Studies.overZones = function () {
  ...
  if (CIQ.Studies.drawZones) { return CIQ.Studies.drawZones.apply(null, arguments) }
}
...
CIQ.Studies.volUnderlay = function () {
  ...
  if (CIQ.Studies.createVolumeChart) { CIQ.Studies.createVolumeChart.apply(null, arguments) }
}
